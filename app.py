...
def page_home():
   ...
   # 이미지 보여주기
   st.image("C:/Users/user/.spyder-py3/images/Package.JPG", caption="반도체 패키징 공정 전체 흐름", use_column_width=True)
   st.markdown("""
   ---
   ### 🧩 주요 공정 설명
...
def page_process_variable_info():
    ...
    if 공정 == "Back Grinding (백래핑)":
        ...
        - **연삭 압력 (10–50 N)**: 
        """)
        st.image("C:/Users/user/.spyder-py3/images/thickness_speed.JPG", caption="백래핑 공정 변수 설정 근거", use_column_width=True)
        st.image("C:/Users/user/.spyder-py3/images/coolant_LAP_pressure.JPG", caption="백래핑 공정 변수 설정 근거", use_column_width=True)
        ...
        - **냉각수 유량(8,20) (L/min)**:          
        """)
        st.image("C:/Users/user/.spyder-py3/images/sawing.JPG", caption="쏘잉 공정 변수 설정 근거", use_column_width=True)
         ...
         """)
         st.image("C:/Users/user/.spyder-py3/images/Die_temp.JPG", caption="다이 어태치 공정 변수 설정 근거", use_column_width=True) 
         st.image("C:/Users/user/.spyder-py3/images/Die.JPG", caption="다이 어태치 공정 변수 설정 근거", use_column_width=True)
        ...
        - **초음파 주파수 (100,150) kHz**:            
        """)
        st.image("C:/Users/user/.spyder-py3/images/Wire.JPG", caption="와이어 본딩 공정 변수 설정 근거", use_column_width=True)
        st.image("C:/Users/user/.spyder-py3/images/ultra_freq.JPG", caption="와이어 본딩 공정 변수 설정 근거", use_column_width=True)
         ...
         - **몰드 레진 점도 : 10⁷ ~ 10⁸Pa·s**:            
         """)
         st.image("C:/Users/user/.spyder-py3/images/Mold_temp.JPG", caption="몰딩 공정 변수 설정 근거", use_column_width=True)
         st.image("C:/Users/user/.spyder-py3/images/Mold_time.JPG", caption="몰딩 공정 변수 설정 근거", use_column_width=True)
         st.image("C:/Users/user/.spyder-py3/images/resin_viscosity.JPG", caption="몰딩 공정 변수 설정 근거", use_column_width=True)
        ...
        - **마킹 깊이: 16 ~ 72µm**:            
        """)
        st.image("C:/Users/user/.spyder-py3/images/mark.JPG", caption="마킹 공정 변수 설정 근거", use_column_width=True)
        st.image("C:/Users/user/.spyder-py3/images/mark_speed.JPG", caption="마킹 공정 변수 설정 근거", use_column_width=True)

def page_prediction():
    st.title("📦 불량률 예측")
    st.markdown("총 40개 이상의 공정 변수를 입력하면, 일부 변수는 상관관계에 따라 자동으로 보정됩니다.")

    df = pd.read_csv("C:/Users/user/.spyder-py3/가상_공정_데이터.csv")
    models = load_models()
